...
// @LINE:57
private[this] lazy val controllers_UserController_profile25 = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("users/all"))))
        

// @LINE:58
private[this] lazy val controllers_UserController_oneUser26 = Route("GET", PathPattern(List(StaticPart(Routes.prefix),StaticPart(Routes.defaultPrefix),StaticPart("users/"),DynamicPart("userId", """[^/]+""",true))))
...
// @LINE:57
case controllers_UserController_profile25(params) => {
   call { 
        invokeHandler(controllers.UserController.profile(), HandlerDef(this, "controllers.UserController", "profile", Nil,"GET", """User Profiles""", Routes.prefix + """users/all"""))
   }
}
        

// @LINE:58
case controllers_UserController_oneUser26(params) => {
   call(params.fromPath[Long]("userId", None)) { (userId) =>
        invokeHandler(controllers.UserController.oneUser(userId), HandlerDef(this, "controllers.UserController", "oneUser", Seq(classOf[Long]),"GET", """""", Routes.prefix + """users/$userId<[^/]+>"""))
   }
}
